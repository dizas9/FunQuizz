export default function ServerInactiveToast() {
  return (
    <>
      ...
      <div className="bg-yellow-100 lg:w-1/2 h-1/2 fixed lg:left-0 bottom-0 lg:top-0 lg:rounded-br-full rounded-tl-full lg:rounded-tl-none rounded-tr-full lg:rounded-tr-none z-10 flex flex-col flex-wrap items-start justify-center px-10">
